        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light p-3 rounded shadow-sm">
                    ...
                    <?php if (isset($_GET['catName']) && $_GET['catName'] != null): ?>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="bg-white rounded shadow-sm p-4">
                        <h4 class="text-center text-danger mb-4 fancy-title"><?php echo isset($_GET['catName']) ? $_GET['catName'] : 'All Products'; ?></h4>
                        <div class="row">
                            <?php
                            if (isset($_GET['catName'])) {
                                $product_fill = $product->product_filter($_GET['catName']);
                            }
                            if ($product_fill) {
                                while ($result = $product_fill->fetch_assoc()) {
                            ?>
